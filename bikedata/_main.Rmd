...
start_date_ym <- trip_2 %>% mutate(ym = paste(year(start_date), 
    month(start_date), sep = "/"), season = ifelse(ym %in% c("2014/10")))
```
...
<!--chapter:end:DATA_MATTMITCH.Rmd-->
