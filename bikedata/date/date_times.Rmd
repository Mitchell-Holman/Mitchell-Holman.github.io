...
```{r dt-algebra, echo = FALSE, fig.cap = "The allowed arithmetic operations between pairs of date/time classes.", out.width="50%"}
knitr::include_graphics("datetimes-arithmetic.png")
```
